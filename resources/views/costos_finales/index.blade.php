...
@section('contenido')
    ...
    <div class="flex justify-end m-4">
        <a href="{{ route('costosfinales.create') }}" class="btn btn-outline">Nueva orden de trabajo</a>
    </div>
            ...
            <div class="card bg-primary text-primary-content w-96 shadow-x1 m-8 p-4 card-normal-size">
                <div class="card-body">
                    @php
                        ...
                        $clienteNombre = $costo->cliente->entidad ? $orden->cliente->entidad : $nombreCompleto;

                        $costoDibujos = $costo_dibujos;
                        $costoGrabados = $costo_grabados;
                        $costoEstampados = $costo_estampados;
                        $costoTotal = $costoDibujos + $costoGrabados + $costoEstampados;
                    @endphp
                    ...
                    <p><strong>Cantidad de Prendas: </strong><span>{{ $costo->orden->total_cantidad_prendas }}</span></p>
                    <p><strong>Cantidad de Estampados: </strong><span>{{ $costo->orden->total_cantidad_estampados }}</span></p>
                    ...
                    <p><strong>Costo Total: </strong><span>{{ $costoTotal }}</span></p>
